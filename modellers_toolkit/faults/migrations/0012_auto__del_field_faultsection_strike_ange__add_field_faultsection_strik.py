...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FaultSection.strike_angle'
        db.add_column('faults_faultsection', 'strike_angle', self.gf('django.db.models.fields.DecimalField')(null=True, max_digits=5, decimal_places=2, blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FaultSection.strike_angle'
        db.delete_column('faults_faultsection', 'strike_angle')
