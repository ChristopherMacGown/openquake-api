...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('faults_faultsection', 'geometry', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FaultSection.geometry'
        db.alter_column('faults_faultsection', 'geometry', self.gf('django.db.models.fields.CharField')(max_length=255))
    ...
    models = {
        ...
        'faults.faultsection': {
            ...
            'geometry': ('django.contrib.gis.db.models.fields.MultiLineStringField', [], {'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
