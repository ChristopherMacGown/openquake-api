...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'FaultSection.geometry'
        raise RuntimeError("Cannot reverse this migration. 'FaultSection.geometry' and its values cannot be restored.")
