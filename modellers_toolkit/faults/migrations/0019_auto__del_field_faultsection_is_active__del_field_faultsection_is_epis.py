...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FaultSection.activity'
        db.add_column('faults_faultsection', 'activity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Deleting field 'FoldTrace.is_active'
        db.delete_column('faults_foldtrace', 'is_active')

        # Deleting field 'FoldTrace.is_episodic'
        db.delete_column('faults_foldtrace', 'is_episodic')

        # Adding field 'FoldTrace.activity'
        db.add_column('faults_foldtrace', 'activity', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FaultSection.activity'
        db.delete_column('faults_faultsection', 'activity')

        # Adding field 'FoldTrace.is_active'
        db.add_column('faults_foldtrace', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Adding field 'FoldTrace.is_episodic'
        db.add_column('faults_foldtrace', 'is_episodic', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)

        # Deleting field 'FoldTrace.activity'
        db.delete_column('faults_foldtrace', 'activity')
    ...
    models = {
        ...
        'faults.faultsection': {
            ...
            'activity': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
