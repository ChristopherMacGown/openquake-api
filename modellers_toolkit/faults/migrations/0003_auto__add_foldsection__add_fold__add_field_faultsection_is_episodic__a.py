...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Fold'
        db.create_table('faults_fold', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ))
        db.send_create_signal('faults', ['Fold'])
        ...
        # Adding field 'Fault.notes'
        db.add_column('faults_fault', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Fault.notes'
        db.delete_column('faults_fault', 'notes')
