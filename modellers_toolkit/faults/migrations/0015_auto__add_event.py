...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Event'
        db.create_table('faults_event', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('section', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['faults.FaultSection'])),
            ('category', self.gf('django.db.models.fields.IntegerField')(default=1)),
            ('historical_eq', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('prehistorical_eq', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal('faults', ['Event'])


    def backwards(self, orm):
        
        # Deleting model 'Event'
        db.delete_table('faults_event')
    ...
    models = {
        ...
        'faults.fault': {
            ...
            'verified_by': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'verifier'", 'null': 'True', 'to': "orm['auth.User']"})
        },
        'faults.faultsection': {
