...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Fault.verified_by'
        db.add_column('faults_fault', 'verified_by', self.gf('django.db.models.fields.related.ForeignKey')(related_name='verifier', null=True, to=orm['auth.User']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Fault.verified_by'
        db.delete_column('faults_fault', 'verified_by_id')
