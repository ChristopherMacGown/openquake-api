...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'FaultSection.downthrown_side'
        db.add_column('faults_faultsection', 'downthrown_side', self.gf('django.db.models.fields.CharField')(default='E', max_length=2), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'FaultSection.downthrown_side'
        db.delete_column('faults_faultsection', 'downthrown_side')
