...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Recurrence.interval'
        db.add_column('faults_recurrence', 'interval', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'Recurrence.earthquake'
        db.add_column('faults_recurrence', 'earthquake', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True), keep_default=False)

        # Adding field 'FaultSection.method'
        db.add_column('faults_faultsection', 'method', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)

        # Adding field 'FaultSection.expression'
        db.add_column('faults_faultsection', 'expression', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)

        # Adding field 'FaultSection.accuracy'
        db.add_column('faults_faultsection', 'accuracy', self.gf('django.db.models.fields.DecimalField')(default=0.10000000000000001, max_digits=3, decimal_places=2), keep_default=False)

        # Adding field 'FaultSection.slip_type'
        db.add_column('faults_faultsection', 'slip_type', self.gf('django.db.models.fields.IntegerField')(default=3), keep_default=False)

        # Adding field 'FaultSection.notes'
        db.add_column('faults_faultsection', 'notes', self.gf('django.db.models.fields.TextField')(default='', blank=True), keep_default=False)

        # Changing field 'FaultSection.slip_rate'
        db.alter_column('faults_faultsection', 'slip_rate', self.gf('django.db.models.fields.IntegerField')(default=3, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Recurrence.interval'
        db.delete_column('faults_recurrence', 'interval')

        # Deleting field 'Recurrence.earthquake'
        db.delete_column('faults_recurrence', 'earthquake')

        # Deleting field 'FaultSection.method'
        db.delete_column('faults_faultsection', 'method')

        # Deleting field 'FaultSection.expression'
        db.delete_column('faults_faultsection', 'expression')

        # Deleting field 'FaultSection.accuracy'
        db.delete_column('faults_faultsection', 'accuracy')

        # Deleting field 'FaultSection.slip_type'
        db.delete_column('faults_faultsection', 'slip_type')

        # Deleting field 'FaultSection.notes'
        db.delete_column('faults_faultsection', 'notes')
    ...
    models = {
        ...
        'faults.faultsection': {
            ...
            'slip_rate': ('django.db.models.fields.IntegerField', [], {'default': '3'}),
