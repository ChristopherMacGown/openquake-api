...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'FaultSection.geometry'
        db.alter_column('faults_faultsection', 'geometry', self.gf('django.contrib.gis.db.models.fields.LineStringField')(null=True))


    def backwards(self, orm):
        
        # Changing field 'FaultSection.geometry'
        db.alter_column('faults_faultsection', 'geometry', self.gf('django.contrib.gis.db.models.fields.MultiLineStringField')(null=True))
