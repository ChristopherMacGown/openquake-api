...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Fault.last_updated'
        db.alter_column('faults_fault', 'last_updated', self.gf('django.db.models.fields.DateField')(auto_now=True))

        # Changing field 'Fault.created_at'
        db.alter_column('faults_fault', 'created_at', self.gf('django.db.models.fields.DateField')(auto_now_add=True))


    def backwards(self, orm):
        
        # Changing field 'Fault.last_updated'
        db.alter_column('faults_fault', 'last_updated', self.gf('django.db.models.fields.DateTimeField')(auto_now=True))

        # Changing field 'Fault.created_at'
        db.alter_column('faults_fault', 'created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
    ...
    models = {
        ...
        'faults.faultsection': {
            ...
            'geometry': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
